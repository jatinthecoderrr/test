  ...
  return (
    <div className="flex items-center gap-3">
      <div className="relative w-[110px] h-[110px]">
        ...
        <div className="absolute inset-0 flex items-center justify-center text-orange-600 font-bold text-lg md:text-xl">
          {percent}%
        </div>
      </div>
      <h5 className="font-semibold text-base md:text-lg">{label}</h5>
    </div>
  );
};
