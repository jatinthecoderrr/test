...
import ScrollingTechStack from "./Markquee";
import TrustedStatsSection from "./Trusted";
import StatsGrid from "./StatsSection";
...
const HeroSection = () => {
  return (
    ...
    <div className="bg-[url('/Bg2.png')] bg-cover">
      <SocialMediaHeader />
      <section className="w-full pt-25 pb-10 flex items-center justify-center  relative">
        ...
        >
          {heroData.map((slide, index) => (
            <SwiperSlide key={index}>
              <div className="flex flex-col items-center justify-center h-full text-center px-6 py-9 md:mx-16 xl:mx-36 md:mt-2 ">
                ...
                <button
                  className="bg-black font-bold text-white px-6 py-3 mb-1 rounded-full text-base md:text-lg 
             hover:bg-gray-300 hover:text-black hover:border border-gray-800 transform hover:scale-107 
