...
const SCROLL_DISTANCE_OFFSET = 0.5;
...
const timelineData = [
  {
    ...
    description:
      "We tailor our web design process to match client's business goals, ensuring effective delivery. Our initial process focuses on customized solutions for optimal results.",
  ...
  },
  {
    ...
    title: "PLANNING",
    description:
      "Because it's awesome! We implement cutting-edge solutions using modern technologies and best practices.",
  ...
  },
  {
    ...
    title: "DESIGN",
    description:
      "Because you need rest. Proper rest ensures peak performance and creative problem-solving abilities.",
    icon: BsMenuButton,
    category: "rest",
    status: "in-progress",
  },
  {
    ...
    title: "DEVELOPMENT",
    description:
      "Because this is the life you love! Continuous improvement and iteration drive excellence.",
    icon: BsFileCode,
    category: "iteration",
    status: "planned",
  },
  ...
  if (isMobile) {
    return (
      <div className="flex items-start mb-12 relative">
        <div className="flex flex-col items-center relative z-10 mr-4 flex-shrink-0">
          <div
            ref={iconRef}
            className={`
        ...
        <div className="flex-1 min-w-0">
          ...
          >
            <div className="flex items-start gap-3 mb-3">
              ...
              <h3 className="text-lg sm:text-xl font-bold text-red-600 leading-tight">
                {item.title}
              </h3>
            </div>
            <p className="text-gray-700 text-sm sm:text-base leading-relaxed ml-5">
              {item.description}
            </p>
          </StyledPaper>
        </div>
  ...
  return (
    ...
    >
      <div className={`w-5/12 ${isLeft ? "pr-8" : "pl-8"}`}>
        <StyledPaper isVisible={isVisible} delay={index * 300} isLeft={isLeft}>
          <div
...
const Timeline = () => {
  ...
  return (
    <section
      className="bg-gradient-to-r from-[#fdf2e4]/50 via-[#fc2310]/25 to-[white]/50 to-[#dadef5]/75 py-8 sm:py-16 px-4 overflow-hidden min-h-screen"
      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          <div className="inline-block px-4 py-2 mb-4">
            <div className="text-black extra-bold font-medium text-sm flex gap-2 uppercase tracking-wide">
              <TriangleBullet /> <span>WORK PROCESS</span>
            </div>
          </div>
          <h2 className="text-3xl sm:text-5xl lg:text-6xl font-bold bg-black bg-clip-text text-transparent mb-4 sm:mb-6 leading-tight">
            Our Work Process
          </h2>
        </div>
        <div className="relative" ref={timelineRef} role="list">
          ...
          >
            ...
            />
            <div
              className="absolute w-3 h-3 sm:w-4 sm:h-4 bg-red-500 rounded-full shadow-lg transition-all duration-100 ease-linear pulse"
