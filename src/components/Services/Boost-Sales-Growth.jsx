...
const timelineData = [
  {
    ...
    description:
      "Website design helps convey the hierarchy of actions, guiding users on what to prioritize and do next.",
    icon:TiFlowMerge        ,
  },
  {
    id: 2,
    ...
    description:
      "Our experts specialize in creating diverse themes for Prestashop, making us the preferred partner for eCommerce development in Chennai.",
    icon: BsSliders  ,
  ...
  },
  {
    ...
    description:
      "Success relies on quality, so planning, testing, and monitoring your marketing strategy is key to making better future decisions.",
    icon: FaSortAmountUp ,
    category: "rest",
    status: "in-progress",
  },
  {
    ...
    description:
      "In online marketing, what Google says about your service matters more than what you say about it.",
    icon:BsSearch  ,
    category: "iteration",
    status: "planned",
  },
...
const stepTitles = ["1.Prioritization", "2.Customization", "3.Optimization", "4.Reputation"];
...
const TimelineItemComponent = ({
  ...
  if (isMobile) {
    return (
      <div className="flex items-start mb-10 relative">
        <div className="flex flex-col items-center relative z-10 mr-1 mt-4 flex-shrink-0">
          <div
            ref={iconRef}
            className={`
          ...
          >
            <Icon
              className={`w-5  h-5 md:w-4 sm:h-4 ${
        ...
        <div className="flex-1 min-w-0">
          ...
          >
            <div className="flex items-start gap-3 mb-1">
              <div className="w-2 h-2bg-red-500 rounded-full mt-2 flex-shrink-0 pulse" />
              <h3 className="text-xl sm:text-[1.35rem]  font-bold text-[#fc2411] leading-tight">
                {item.title}
              </h3>
            </div>
    ...
    >
      <div className={`w-[46%] ${isLeft ? "pr-4" : "pl-4"} relative`}>
        ...
        <StyledPaper isVisible={isVisible} delay={index * 75} isLeft={isLeft} className={isLeft ? "mr-0" : "ml-0"}>
          ...
          >
            <h3
            className={`text-2xl sm:text-[1.5rem] font-semibold  text-black ${
  ...
  <span
    className={`
      ...
      ${index % 2 === 0 ? "-right-23 text-left" : "-left-25 text-right"}
    `}
...
const Timeline = () => {
  ...
  return (
    <section
      className="bg-[url('/body-bg-2-scaled-1.jpg')] py-8 sm:py-5  px-4 overflow-hidden min-h-screen"
      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          <div className="inline-block px-4 py-2 my-4">
            <div className="text-[13px] md:pt-5 sm:text-[16px] text-gray-800 font-extrabold md:text-[17px] leading-[16px] sm:leading-[17px]  uppercase tracking-wider flex items-center justify-start md:justify-center gap-2 font-urbanist pb-1 sm:pb-2">
      <TriangleBullet /> Web design
      </div>
          </div>
        ...
        <div className="relative" ref={timelineRef} role="list">
          ...
          >
            <div
              ref={lineRef}
              className="w-full bg-gradient-to-b from-red-500 to-[#fc2411] transition-all duration-100 ease-linear"
