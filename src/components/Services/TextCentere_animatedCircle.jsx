  ...
  return (
    ...
    >
      <div className="container mx-auto px-4 text-center text-white">
        ...
        {/* Description */}
        <p className="max-w-4xl mx-auto text-gray-100 font-medium mb-12 text-base sm:text-lg md:text-[18px]  leading-relaxed px-2">
          {description}
        </p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-10">
          {features.map((feature, index) => (
            ...
            >
              <div className="w-32 h-32 sm:w-36 sm:h-36 md:w-40 md:h-40 mx-auto mb-6 rounded-full overflow-hidden border-2 border-white transform transition duration-900 ease-out hover:scale-105 hover:rotate-6 hover:shadow-xl">
                <img
                  src={feature.img}
                  alt={feature.title}
              ...
              <p className="text-gray-100 text-sm sm:text-base font-medium max-w-xs mx-auto">
                {feature.description}
              </p>
            </div>
          ))}
