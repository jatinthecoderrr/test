...
const AnimatedSection = ({
  ...
  return (
    <section
      className="w-full py-10 px-6 sm:py-14 md:py-16 md:px-16"
      style={{
    ...
    >
      <div className="max-w-7xl mx-auto   grid grid-cols-1 md:grid-cols-2 items-center gap-8 md:gap-12">
        {/* Left: Text */}
        <div className="order-1 md:order-1" ref={textRef}>
          <div
          ...
          >
            <h5
              className={`flex items-center gap-3 text-base sm:text-lg md:text-[19px] font-extrabold uppercase transition-all duration-700 delay- text-gray-600 ${
                textVisible
            ...
            <p
              className={`text-gray-600 font-medium text-base sm:text-lg md:text-[18px] leading-relaxed transition-all duration-700 delay-300 ${
                textVisible
                  ? "translate-x-0 opacity-100"
                  : "translate-x-10 opacity-0"
              }`}
            ...
            <div
              className={`transition-all duration-700 delay-300 mt-5 md:mt-10  ${
                textVisible
                  ? "translate-x-0 opacity-100"
                  : "translate-x-10 opacity-0"
              }`}
