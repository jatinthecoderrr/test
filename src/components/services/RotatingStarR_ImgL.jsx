...
function RotatingStarR_ImgL({
  ...
  return (
    <section
      className="w-full py-8 px-4 sm:px-6 md:py-14 md:px-8 lg:px-14 bg-white"
      style={{
    ...
    >
      <div className="container mx-auto grid md:grid-cols-2 items-center gap-8 md:gap-12">
        {/* Left: Image */}
        <div id="img-col" className="flex justify-center order-2 md:order-1">
          <div
            ref={imgRef}
        ...
        {/* Right: Text */}
        <div className="order-1 md:order-2 mx-5" ref={textRef}>
          <div
...
export default RotatingStarR_ImgL;
