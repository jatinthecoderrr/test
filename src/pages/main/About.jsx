...
import "../../coustomCSS/splitText.css"; // Assuming you have custom animations defined here
...
const About = () => {
  const services = [
    ...
    },
    {
      ...
      icon: "/custom-business-solution.webp",
      bg: "https://geektheo.copreneurs.in/wp-content/uploads/2024/06/ser-bg.webp",
    },
    {
    ...
    },
    {
      ...
      link: "https://geektheo.com/content-marketing-services/",
      icon: "/pos.webp",
      bg: "bg-white",
    },
    {
      ...
      link: "https://geektheo.com/branding-agency/",
      icon: "/LMS.webp",
      bg: "bg-white",
    },
    {
      ...
      link: "https://geektheo.com/social-media-marketing-agency/",
      icon: "/Classified-Ads-Solutions.webp",
      bg: "bg-white",
    },
    {
      title: "Digital Marketing",
      description: "Boost visibility, drive targeted engagement.",
      link: "https://geektheo.com/video-production-services/",
      icon: "/Digital_marketing.webp",
      bg: "bg-white",
    },
    {
      title: "Hire Developers",
      description: "Find talent, build innovative solutions.",
      link: "https://geektheo.com/it-consulting-services/",
      icon: "/hire-developer.webp",
      bg: "bg-white",
    },
  ];
  const images = [
    { src: "/work.webp", alt: "Image 1" },
    { src: "/011-scaled.webp", alt: "Image 1" },
    { src: "/13.0.webp", alt: "Image 2" },
    { src: "/08.webp", alt: "Image 3" },
    { src: "/06.webp", alt: "Image 4" },
    { src: "/04-scaled.webp", alt: "Image 5" },
    { src: "/055-scaled.webp", alt: "Image 6" },
    { src: "/07.webp", alt: "Image 7" },
    { src: "/11.1.webp", alt: "Image 8" },
    { src: "/09.webp", alt: "Image 9" },
    { src: "/12.webp", alt: "Image 10" },
    { src: "/10.jpg", alt: "Image 11" },
    { src: "/02-scaled.webp", alt: "Image 13" },
    { src: "/20250215_1236232-scaled.webp", alt: "Image 14" },
    { src: "/work-area.webp", alt: "Image 15" },
    { src: "/03-scaled.webp", alt: "Image 16" },
  ];
    ...
    <>
      ...
      <section className="w-full py-12 bg-[#f5f3f0]">
        <div className="container mx-auto px-4 text-center">
          {/* Subtitle */}
          <div className="text-[rgb(91, 91, 91)] justify-center items-center flex gap-3 text-[19px] font-weight:900 font-extrabold mb-2 uppercase animate-fadeInDown">
                  ...
                  <div className="bg-white rounded-2xl gap-4 shadow-lg p-6 flex flex-col justify-between h-auto min-h-[300px] transition-transform group">
                    <div className="flex flex-col gap-4 relative">
                      ...
                      <div>
                        ...
                        <button className="absolute -bottom-16 right-4 w-10 h-10 flex items-center justify-center rounded-full bg-gray-100 hover:bg-[#e82110] transition group/arrow">
                          <FaArrowRight className="text-black group-hover/arrow:text-white transition" />
                        </button>
                      </div>
                    </div>
